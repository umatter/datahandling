...
- Thursday, 20 December, *morning*
    - final exercise session (Mock Exam and visualisation exercises)
    - Feedback
    - Q&A 
- Thursday, 20 December, *afternoon*
    - Decentral exam for exchange students!

## Mock exam answer sheet

- Example of scan in StudyNet
- Questions?

## Mock exam answer sheet: Student ID (Matr.-Nr.)
```{r echo=FALSE, purl=FALSE, out.width="60%"}
include_graphics("../img/mock_exam_scan.png")
```
