...
This tutorial guides you step-by-step through the cleaning script (with a few adaptions) of [tidytuesday's Hotel Bookings repo](https://github.com/rfordatascience/tidytuesday/tree/master/data/2020/2020-02-11), dealing with the preparation and analysis of two datasets with *hotel demand data*. Along the way, you also get in touch with the [janitor package](https://github.com/sfirke/janitor). For details about the two datasets see [@nuno_etal2019](https://www.sciencedirect.com/science/article/pii/S2352340918315191#f0010) and for the original research contribution related to these datasets see [@nunes_etal2017](https://ieeexplore.ieee.org/document/8260781).
...
The the first few rows and columns of the final dataset should combine the two source datasets and look as follows and should contain all the observations from both datasets (H1 and H2).
