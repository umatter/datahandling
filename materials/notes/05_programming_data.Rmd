...
### For-loops
In simple terms, a for-loop tells the computer to execute a sequence of commands 'for each case in a set of n cases'. The flow-chart in Figure \@ref(for) illustrates the concept.

```{r for, echo= FALSE, fig.align="center", out.width="40%", fig.cap="(ref:for)", purl=FALSE}
...
include_graphics("../img/while-loop.png")
```
