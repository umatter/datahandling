...
This appendix provides background on key statistical concepts that underpin data analysis. Understanding these concepts helps interpret the results of statistical tests and modeling.
...
$$SSR = \sum{u_i^2}=\sum{(y_{i}-\hat{\alpha}-\hat{\beta} x_i)^2}$$
...
abline(a = alpha, b = beta, col = "blue", lwd = 2)  # true line
abline(a = estimates$alpha, b = estimates$beta, col = "red", lwd = 2, lty = 2)  # estimated line
legend("topleft", legend = c("True", "Estimated"), col = c("blue", "red"), lty = c(1, 2), lwd = 2)
```
