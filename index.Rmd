...
title: "Data Handling Pocket Reference"
author: "Ulrich Matter"
date: "`r Sys.Date()`"
description: "A guide to practical data handling with a focus on R and data analytics in economics and the social sciences."
...
## Prerequisites and aims {.unnumbered}
...
<!-- This textbook introduces students and practitioners to the fundamental practices of data science in the context of economic and social science research. The book summarizes basic concepts and practices in gathering, preparing/cleaning, visualizing, storing, and analyzing digital -->
<!-- data for research and analytics purposes. -->

<!-- You'll learn both theoretical aspects of what digital data is and how to handle it for analytics purposes in R, focusing on different data structures and data formats from structured data to raw text data and images). This book addresses common practical challenges underlying the crucial first steps underlying empirical research projects and shows how to efficiently overcome them.  -->
