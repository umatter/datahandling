...
```{r matrix, warning=FALSE, message=FALSE, echo=FALSE, out.width="15%",fig.align='center', fig.cap= "(ref:capmatrix)", purl=FALSE}
include_graphics("img/matrix.png")
```

(ref:capmatrix) Illustration of an integer matrix.

```{r array, warning=FALSE, message=FALSE, echo=FALSE, out.width="25%", fig.align='center', fig.cap= "(ref:caparray)", purl=FALSE}
include_graphics( "img/array.jpg")
```

(ref:caparray) Illustration of three-dimensional integer array.
...
(ref:caplist) Illustration of a list.
