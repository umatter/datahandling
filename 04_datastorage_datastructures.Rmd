...
```
(ref:capbitbyteword) Byte and bit.
...
```{r matrix, warning=FALSE, message=FALSE, echo=FALSE, out.width="40%",out.height="40%",fig.show='hold', fig.align='center', fig.cap= "(ref:capmatrix)", purl=FALSE}
include_graphics(c("img/matrix.png", "img/array.jpg"))
```

(ref:capmatrix) Illustration of an integer matrix and array.

In R, we can, for example, initiate a three-row/three-column numeric matrix as follows
...
```{r}
my_array <- array(sample(0:(3*3*3)), dim = c(3,3,3))
my_array
